...
int main() {
    ...
    std::cout << std::endl << std::endl << " --- just big map ---" << std::endl;
    std::map<char, int> map5;
    map5.insert(std::pair<char,int>('t',6));
    map5.insert(std::pair<char,int>('u',6));
    map5.insert(std::pair<char,int>('v',6));
    map5.insert(std::pair<char,int>('w',6));
    map5.insert(std::pair<char,int>('x',6));
    map5.insert(std::pair<char,int>('y',6));
    map5.insert(std::pair<char,int>('z',6));
...
//    map5.insert(std::pair<char,int>('h',10));
//    map5.insert(std::pair<char,int>('i',16));
//    map5.insert(std::pair<char,int>('j',6));
//    map5.insert(std::pair<char,int>('k',6));
//    map5.insert(std::pair<char,int>('l',6));
//    map5.insert(std::pair<char,int>('m',6));
//    map5.insert(std::pair<char,int>('n',6));
//    map5.insert(std::pair<char,int>('o',6));
//    map5.insert(std::pair<char,int>('p',6));
//    map5.insert(std::pair<char,int>('q',6));
//    map5.insert(std::pair<char,int>('r',6));
//    map5.insert(std::pair<char,int>('s',6));
    printMap(map5);

    ft::map<char, int> ft_map5;
    ft_map5.insert(std::pair<char,int>('t',6));
    ft_map5.insert(std::pair<char,int>('u',6));
    ft_map5.insert(std::pair<char,int>('v',6));
    ft_map5.insert(std::pair<char,int>('w',6));
    ft_map5.insert(std::pair<char,int>('x',6));
    ft_map5.insert(std::pair<char,int>('y',6));
    ft_map5.insert(std::pair<char,int>('z',6));
...
//    ft_map5.insert(std::pair<char,int>('h',10));
//    ft_map5.insert(std::pair<char,int>('i',16));
//    ft_map5.insert(std::pair<char,int>('j',6));
//    ft_map5.insert(std::pair<char,int>('k',6));
//    ft_map5.insert(std::pair<char,int>('l',6));
//    ft_map5.insert(std::pair<char,int>('m',6));
//    ft_map5.insert(std::pair<char,int>('n',6));
//    ft_map5.insert(std::pair<char,int>('o',6));
//    ft_map5.insert(std::pair<char,int>('p',6));
//    ft_map5.insert(std::pair<char,int>('q',6));
//    ft_map5.insert(std::pair<char,int>('r',6));
//    ft_map5.insert(std::pair<char,int>('s',6));
